    ...
    return (
        <div className='w-full flex justify-center bg-[#FFFFFF]'>
            <div className='w-full'>
                ...
                {/* <Parteners /> bg-gray-300/50 */}
                <Parteners />
                <ScrollFadeIn>
                    <Contacts />
                </ScrollFadeIn>
                <ScrollFadeIn>
                    <div className="w-[90%] sm:w-[70%] lg:w-[95%] mx-auto h-px bg-[#F0F0F0]"></div>
                </ScrollFadeIn>
                <ScrollFadeIn>
                    <div className="bg-[#FFF9E6] flex flex-col items-center gap-5 lg:flex-row lg:justify-center lg:items-center">
